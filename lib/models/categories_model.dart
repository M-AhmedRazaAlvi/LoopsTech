class CategoriesModel {
  ...
  CategoriesModel({this.code, this.msg, this.data});
...
class Data {
  ...
  Data({this.mainCat, this.parentCatsId, this.catId, this.subCatId, this.categoryName, this.categoryDescription, this.categoryPic});
